...
CITYSCAPES_DIR = '/home/zaikun/hdd/data/keypoint/val2017/'
...
if __name__ == '__main__':
    ...
    if not os.path.exists(args.engine):
        ...
        engine.save("mobilepose_int8.engine")
    else:
        engine = trt.utils.load_engine('./', args.engine)
    ...
    convas[:, 640:] = image
    cv2.imwrite("cmupose_int8.jpg", image)