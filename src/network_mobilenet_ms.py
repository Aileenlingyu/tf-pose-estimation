...
class MobilenetNetworkZaikunMs(network_base.BaseNetwork):
    ...
    def setup(self):
        ...
        with tf.variable_scope(None, 'Openpose'):
            ...
            (self.feed(feature_lv)
             .separable_conv(3, 3, depth2(128), 1, name=prefix + '_eL1_1')
             .separable_conv(3, 3, depth2(128), 1, name=prefix + '_eL1_2')
             # .separable_conv(3, 3, depth2(128), 1, name=prefix + '_L1_3')
             # .separable_conv(1, 1, depth2(128), 1, name=prefix + '_L1_4')
             .separable_conv(1, 1, 38, 1, relu=False, name=prefix + '_eL1_5'))

            (self.feed(feature_lv)
             .separable_conv(3, 3, depth2(128), 1, name=prefix + '_eL2_1')
             .separable_conv(3, 3, depth2(128), 1, name=prefix + '_eL2_2')
             # .separable_conv(3, 3, depth2(128), 1, name=prefix + '_L2_3')
             # .separable_conv(1, 1, depth2(128), 1, name=prefix + '_L2_4')
             .separable_conv(1, 1, 19, 1, relu=False, name=prefix + '_eL2_5'))
    ...
    def loss_l1_l2(self):
        ...
        large_l1s = [self.layers['large_eL1_5']]
        large_l2s = [self.layers['large_eL2_5']]

        return l1s, l2s, large_l1s, large_l2s

    def loss_last(self):
        return self.get_output('MConv_Stage4_L1_5'), self.get_output('MConv_Stage4_L2_5'), self.get_output('large_eL1_5'), self.get_output('large_eL2_5')
