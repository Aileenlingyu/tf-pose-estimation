        ...
        with tf.variable_scope(None, 'Openpose'):
            ...
            for stage_id in range(self.num_refine):
                ...
                (self.feed(prefix_prev + '_L1_5',
                 ...
                 .separable_conv(7, 7, depth2(128), 1, 1, name=prefix + '_L1_1')
                 .separable_conv(7, 7, depth2(128), 1, 1, name=prefix + '_L1_2')
                 .separable_conv(7, 7, depth2(128), 1, 1, name=prefix + '_L1_3')
                 .separable_conv(1, 1, depth2(128), 1, 1, name=prefix + '_L1_4')
                 .separable_conv(1, 1, 38, 1, 1, relu=False, name=prefix + '_L1_5'))

                (self.feed(prefix + '_concat')
                 .separable_conv(7, 7, depth2(128), 1, 1, name=prefix + '_L2_1')
                 .separable_conv(7, 7, depth2(128), 1, 1, name=prefix + '_L2_2')
                 .separable_conv(7, 7, depth2(128), 1, 1, name=prefix + '_L2_3')
