...
if __name__ == '__main__':
    ...
    with tf.device(tf.DeviceSpec(device_type="GPU", device_index=0)):
        ...
        vectmap_node = tf.placeholder(tf.float32, shape=(args.batchsize, output_h, output_w, 26), name='vectmap')
        heatmap_node = tf.placeholder(tf.float32, shape=(args.batchsize, output_h, output_w, 13), name='heatmap')
