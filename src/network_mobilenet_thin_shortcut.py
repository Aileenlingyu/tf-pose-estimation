...
class MobilenetNetworkThinShortcut(network_base.BaseNetwork):
    ...
    def setup(self):
        ...
        self.feed('Conv2d_3_pool').separable_conv(3, 3, depth2(128), 1, name='bn1')
        self.feed('Conv2d_3_pool').separable_conv(3, 3, depth2(128), 1, name='bn2')
        ...
        with tf.variable_scope(None, 'Openpose'):
            ...
            self.feed(prefix + '_L1_4', 'bn1')\
                .add(3, name=prefix + '_L1_concat').separable_conv(1, 1, 38, 1, relu=False, name=prefix + '_L1_5')
            ...
            self.feed(prefix + '_L2_4', 'bn2') \
                .add(3, name=prefix + '_L2_concat').separable_conv(1, 1, 19, 1, relu=False, name=prefix + '_L2_5')
            ...
            (self.feed('MConv_Stage6_L2_5',
                       'MConv_Stage6_L1_5').concat(3, name='concat_stage7'))
