...
do 
	...
	python3 src/eval.py --model=$model  --input-width=800 --input-height=600
done
...
CUDA_VISIBLE_DEVICES=0 python3 src/eval_caffemodel.py  --input-width=800 --input-height=600
